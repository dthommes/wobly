...
public class CollectionTypeCodeGenerator implements TypeCodeGenerator
{
	...
	public static String appendReadTypeCodeImpl(CodeBuilder result, Type type, Class<?> clazz, String obj, Object componentsDetails,
			WoblyField of, int depth)
	{
		...
		String initialSize = "";
		if (classType.contains("Hash"))
			initialSize = sizeVar+"*2";
		else if (classType.contains("Array"))
				initialSize = sizeVar;
