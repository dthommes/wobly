...
public class CompressedUnknownField extends UnknownField
{
	private final long value;
	
	public CompressedUnknownField(ByteBuffer buf, int tag) {
		super(tag);
		value = Buffers.getVLong(buf);
	}

	@Override
	public int getSize()
	{
		return Buffers.sizeVInt(tag) + Buffers.sizeVLong(value);
	}
