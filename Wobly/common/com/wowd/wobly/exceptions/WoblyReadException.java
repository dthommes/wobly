...
public class WoblyReadException extends WoblyException
{
	public WoblyReadException() {
		super();
	}

	public WoblyReadException(String s) {
		super(s);
	}
	
	public WoblyReadException(Throwable t) {
		super(t);
	}
}
