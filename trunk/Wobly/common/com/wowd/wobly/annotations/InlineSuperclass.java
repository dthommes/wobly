...
public @interface InlineSuperclass {
	/**
	 * TypeID that represent current class.
	 * Should be unique in current hierarchy,
	 * ie in all classes that are children from  
	 * the furthest parent that has AbstractType
	 * annotation on it. 
	 * @return
	 */
	byte value();
