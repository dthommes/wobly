 ...
 *******************************************************************************/
package com.wowd.wobly.exceptions;

public class WoblyWriteException extends WoblyException
{

	public WoblyWriteException() {
		super();
	}

	public WoblyWriteException(String s) {
		super(s);
	}
	
	public WoblyWriteException(Throwable t) {
		super(t);
	}
}
